...
E("preenche o formulário e envia") do
  ...
  @create_account_page.input_company_address.set('Compasso UOL')
  ...
  @create_account_page.input_additional_information.set('Não tenho nada a adicionar')
  @create_account_page.input_home_phone.set('71995682207')
  @create_account_page.input_mobile_phone.set('71987440763')
  @create_account_page.input_alias.set('Endereço principal')
